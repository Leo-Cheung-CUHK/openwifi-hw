...
puts $fd "`define NUM_CLK_PER_US 200"
close $fd
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../ip_repo/high/mv_avg128/src/mv_avg128.v"]"\
 "[file normalize "$origin_dir/../../ip_repo/high/mv_avg32/src/mv_avg32.v"]"\
 ...
 "[file normalize "$origin_dir/src/tsf_tracker.v"]"\
...
set file "$origin_dir/../../ip_repo/high/mv_avg128/src/mv_avg128_fir_compiler_0_0/mv_avg128_fir_compiler_0_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
set file "$origin_dir/../../ip_repo/high/mv_avg128/src/mv_avg128.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../ip_repo/high/mv_avg32/src/mv_avg32.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/tsf_tracker.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
