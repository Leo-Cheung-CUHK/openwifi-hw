...
module duc_bank_core
  ...
  duc_bank_core_fir_compiler_0_0 fir_compiler_0
       (.aclk(clk_1),
        .aresetn(rstn_1),
        .m_axis_data_tdata(fir_compiler_0_M_AXIS_DATA_TDATA),//out
        .m_axis_data_tready(fir_compiler_0_M_AXIS_DATA_TREADY),//in
        .m_axis_data_tvalid(fir_compiler_0_M_AXIS_DATA_TVALID),//out
        .s_axis_data_tdata(bw20_data_1_TDATA),//in
        .s_axis_data_tready(bw20_data_1_TREADY),//out
        .s_axis_data_tvalid(bw20_data_1_TVALID));//in
  duc_bank_core_mixer_duc_0_0 mixer_duc_0
       (.ap_clk(clk_1),
        .ap_rst_n(rstn_1),
        .cfg0_V(cfg0_1),
        .d_i0_V_TDATA(fir_compiler_0_M_AXIS_DATA_TDATA), //in
        .d_i0_V_TREADY(fir_compiler_0_M_AXIS_DATA_TREADY), //out
        .d_i0_V_TVALID(fir_compiler_0_M_AXIS_DATA_TVALID), //in
        .d_o_V_din(mixer_duc_0_d_o_V_WR_DATA),//out
        .d_o_V_full_n(mixer_duc_0_d_o_V_FULL_N),//in
        .d_o_V_write(mixer_duc_0_d_o_V_WR_EN));//out
endmodule
